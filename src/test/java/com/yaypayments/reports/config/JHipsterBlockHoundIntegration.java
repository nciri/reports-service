package com.yaypayments.reports.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.yaypayments.reports.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.yaypayments.reports.security.DomainUserDetailsService", "createSpringSecurityUser");
